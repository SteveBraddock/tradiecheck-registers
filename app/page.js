  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', marginBottom: 0 }}>
        ...
        <div style={{
          width: COL_W * 2 + 8, flexShrink: 0, marginRight: 6,
          background: '#0E1E30', border: '1px solid #1A3A5A',
        ...
        {[
          ...
          <div key={i} style={{
            width: COL_W, flexShrink: 0, marginRight: i < 2 ? 6 : 0,
            background: p.dim ? '#0A0E14' : '#0E1E30',
            border: `1px solid ${p.dim ? '#141E2A' : '#1A3A5A'}`,
            borderRadius: '8px 8px 0 0', padding: '10px 14px 8px',
          }}>
      ...
      <div style={{ display: 'flex', marginBottom: 6 }}>
        <div style={{ width: LANE_LABEL_W, flexShrink: 0 }} />
        {[{ id: 'p1w', label: 'Wellington', period: 'Apr – Jul' }, { id: 'p1n', label: 'National', period: 'Jul – Dec' }].map((s, i) => (
          <div key={s.id} style={{
            width: COL_W, flexShrink: 0, marginRight: 8,
            background: '#0A1828', border: '1px solid #1A3A5A',
            borderTop: 'none', padding: '5px 14px 6px',
          }}>

...
const SEED_WORKSTREAMS = [
  {
    ...
    items: [
      ...
      { item_text: "FSP Act â€” no registration required", item_status: "done", owner: "Dentons", sort_order: 2 },
      { item_text: "AML/CFT Act â€” not a reporting entity", item_status: "done", owner: "Dentons", sort_order: 3 },
      { item_text: "CCA retention money â€” not applicable to TradieCheck (carve-out required in T&Cs for non-residential-occupier contracts)", item_status: "done", owner: "Dentons", sort_order: 4 },
      { item_text: "T&Cs drafting â€” escrow provider visibility, liability exclusion, CCA carve-out", item_status: "not_started", owner: "Steve Braddock", sort_order: 5 },
  ...
  },
  {
    ...
    items: [
      ...
      { item_text: "Funding approach â€” best approach agreed across founders", item_status: "not_started", owner: "Steve / Founders", sort_order: 2 },
  ...
  },
  {
    ...
    items: [
      ...
      { item_text: "Path A (Company/Trust/Partnership) onboarding â€” multi-step mock deployed", item_status: "done", owner: "Mike Gollop", sort_order: 2 },
      ...
      { item_text: "Escrow UI design (IPromise integration) â€” pending formal briefing", item_status: "not_started", owner: "Mike Gollop", sort_order: 7 },
      { item_text: "HNRY API integration scoping â€” pending partnership outreach", item_status: "not_started", owner: "Mike Gollop", sort_order: 8 },
    ]
  },
  {
    title: "Escrow Partner", status: "amber", sort_order: 4,
    summary: "IPromise is primary candidate (FSP-registered, NZ-based). Formal briefing now unblocked by Dentons opinion. FSP registration confirmation required before briefing issued. Direct legal relationship capability remains unconfirmed â€” critical open question.",
    items: [
      ...
      { item_text: "Issue formal escrow partner briefing â€” IPromise primary", item_status: "not_started", owner: "Steve Braddock", sort_order: 5 },
  ...
  },
  {
    ...
    summary: "Waitapu Group confirmed as marketing partner (Greg Partington, Elizabeth Beatty). Handover pack in progress â€” seven documents ready, four previously held pending Dentons (now cleared). Teams hui to be arranged. Agency pipeline identified.",
    items: [
      ...
      { item_text: "Agency brief â€” Stanley St / Culture / Content Depot pipeline", item_status: "not_started", owner: "Waitapu Group", sort_order: 8 },
  ...
  },
  {
    ...
    items: [
      ...
      { item_text: "Mike Gollop â€” directorship and share allocation (on hold pending separate matter)", item_status: "not_started", owner: "Mike Gollop", sort_order: 4 },
      { item_text: "Jade Clamp â€” full-time activation (tied to business and milestone conditions)", item_status: "not_started", owner: "Jade Clamp", sort_order: 5 },
      { item_text: "Alicia Clamp â€” salary activation October 2026", item_status: "not_started", owner: "Alicia Clamp", sort_order: 6 },
  ...
  },
  {
    ...
    summary: "Financial model v8 built (Python/openpyxl, 36-month April 2026â€“March 2029, Base and Growth scenarios, 17 tabs). Several inputs remain as placeholders pending external confirmation.",
    items: [
      ...
      { item_text: "Monthly dev cost quantum â€” confirm with Mike", item_status: "not_started", owner: "Mike Gollop", sort_order: 2 },
  ...
  },
  {
    ...
    summary: "Recommended structure: new Australian Pty Ltd subsidiary (not foreign branch). Practical setup window Q3â€“Q4 2026 aligned with 2027 AU launch. Name appears clear in AU but manual verification still required.",
    items: [
      { item_text: "Australian Pty Ltd incorporation â€” Q3/Q4 2026", item_status: "not_started", owner: "Steve Braddock", sort_order: 1 },
...
const DEPENDENCIES = [
  ...
  { item: "IPromise â€” direct legal relationship capability", owner: "Steve / IPromise", status: "Pending", note: "Must confirm IPromise can operate with a visible, named, direct legal relationship to customers and tradespersons within the TradieCheck platform. Required by Dentons opinion." },
  { item: "Funding approach â€” founder alignment", owner: "Steve / Founders", status: "Open", note: "Best approach not yet agreed. Options being assessed across founders before any documentation or distribution." },
  ...
  { item: "BDO Wellington â€” deferred tax asset review", owner: "Steve / BDO", status: "Deferred", note: "BDO to assess deferred tax asset recoverability. Timing TBD." },
];
 
const UNBLOCKED = [
  { item: "Formal escrow partner briefing process", note: "IPromise primary â€” subject to FSP registration confirmation first" },
  { item: "Investor materials and funding documentation", note: "Approach not yet agreed â€” funding documentation and seed round materials will both follow founder alignment on best approach" },
  { item: "Waitapu Group handover â€” held documents", note: "Financial Model, Governance Blueprint, Funding terms, Escrow Provider Briefing now cleared" },
...
const HORIZON = [
  ...
  { priority: 2,  item: "Confirm IPromise FSP registration â†’ issue formal escrow briefing",   timing: "This week",        owner: "Steve Braddock"  },
  { priority: 3,  item: "Dentons response on T&C prominence standard",                        timing: "Awaiting",         owner: "Dentons"         },
  { priority: 4,  item: "Agree funding approach across founders â†’ progress documentation",    timing: "April 2026",       owner: "Steve / Founders"},
  ...
  { priority: 7,  item: "Customer segments + positioning/messaging framework",                timing: "Aprilâ€“May 2026",   owner: "Steve / Waitapu" },
  { priority: 8,  item: "Financial model â€” resolve remaining placeholders",                   timing: "Aprilâ€“May 2026",   owner: "Steve / Mike"    },
  { priority: 9,  item: "Mike Gollop â€” directorship and share allocation resolution",         timing: "TBD",              owner: "Mike Gollop"     },
  { priority: 10, item: "Australian Pty Ltd incorporation",                                   timing: "Q3â€“Q4 2026",       owner: "Steve Braddock"  },
];
...
const SNAPSHOT = [
  ...
  { label: "Core products",     value: "TradieCheck (verification) Â· TradieWallet (milestone escrow) Â· SubbieCheck (Phase 2) Â· SupplierCheck (Phase 2)" },
  { label: "Launch plan",       value: "Wellington pilot July 2026 â†’ National October 2026 â†’ Australia 2027" },
  { label: "Team",              value: "Steve Braddock (CEO/CFO) Â· Jade Clamp (CIGO) Â· Mike Gollop (CTO, contractor) Â· Helmut Modlik (NED) Â· Alicia Clamp (Head of Ops, Oct 2026)" },
  { label: "Legal counsel",     value: "Dentons Kensington Swan (Wellington) â€” David Ireland, Partner" },
  ...
  return (
    <div style={{ border: `1.5px solid ${s.border}`, borderRadius: 10, background: WHITE, overflow: "hidden" }}>
      <div onClick={() => setOpen(!open)} style={{ display: "flex", alignItems: "flex-start", gap: 12, padding: "14px 18px", cursor: "pointer", background: s.bg }}>
        ...
        <div style={{ fontSize: 16, color: MID, flexShrink: 0, marginTop: 2 }}>{open ? "â–²" : "â–¼"}</div>
      </div>
          ...
          {items.map((item, i) => {
            ...
            return (
              <div key={item.id} style={{ display: "grid", gridTemplateColumns: "1fr 150px 190px", padding: "10px 16px", gap: 12, alignItems: "center", background: i % 2 === 0 ? WHITE : LIGHT, borderTop: `1px solid ${BORDER}` }}>
                ...
                <div>
                  {isSaving
                    ? <span style={{ fontSize: 11, color: MID, fontFamily: "sans-serif" }}>Savingâ€¦</span>
                    : <select value={item.item_status} onChange={e => handleUpdate(item.id, "item_status", e.target.value)}
                        ...
                        <option value="not_started">ðŸ”² Not Started</option>
                      </select>
                  }
                </div>
                <div>
...
export default function StateOfPlay() {
  ...
  if (loading || seeding) return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: 300, gap: 12 }}>
      ...
      <div style={{ fontSize: 14, color: MID, fontFamily: "sans-serif" }}>{seeding ? "Setting up State of Playâ€¦" : "Loadingâ€¦"}</div>
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "24px 20px 80px", fontFamily: "sans-serif" }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ fontSize: 14, color: MID, marginTop: 4 }}>Internal reference â€” TradieCheck Limited Â· Last updated {LAST_UPDATED}</div>
      </div>
      ...
      <div style={{ background: "#EEF8EE", border: "1.5px solid #6DBE45", borderRadius: 12, padding: "20px 24px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
          ...
          <div>
            <div style={{ fontSize: 15, fontWeight: 700, color: "#1E6B1E", fontFamily: "sans-serif" }}>Items Unblocked â€” 2 April 2026</div>

...
const SEED_WORKSTREAMS = [
  ...
  },
  {
    ...
    summary: "Financial model v8 built (Python/openpyxl, 36-month April 2026–March 2029, Base and Growth scenarios, 17 tabs). Several inputs remain as placeholders pending external confirmation.",
    items: [
...
const HORIZON = [
  ...
  { priority: 2,  item: "Confirm IPromise FSP registration → issue formal escrow briefing",   timing: "This week",        owner: "Steve Braddock"  },
  { priority: 3,  item: "Dentons response on T&C prominence standard",                        timing: "Awaiting",         owner: "Dentons"         },
  { priority: 4,  item: "Agree funding approach across founders → progress documentation",    timing: "April 2026",       owner: "Steve / Founders"},
  ...
  { priority: 7,  item: "Customer segments + positioning/messaging framework",                timing: "April–May 2026",   owner: "Steve / Waitapu" },
  { priority: 8,  item: "Financial model — resolve remaining placeholders",                   timing: "April–May 2026",   owner: "Steve / Mike"    },
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "24px 20px 80px", fontFamily: "sans-serif" }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ fontSize: 14, color: MID, marginTop: 4 }}>Internal reference — TradieCheck Limited · Last updated {LAST_UPDATED}</div>
      </div>
